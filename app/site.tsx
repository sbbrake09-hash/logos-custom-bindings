  ...
  return (
    <footer className="footer">
      <div className="container footer-main">
        <div>
          <a href="/" className="brand" aria-label="Logos Custom Bindings home"><Image unoptimized={process.env.NODE_ENV === "development"} src="/lcb-circle-logo.png" alt="" width={44} height={44} className="brand-logo" /><span className="brand-text"><strong>Logos</strong><small>Custom Bindings</small></span></a>
          <p>Custom Bible rebinding and restoration, hand-bound journals, personalized book details, and one-of-a-kind custom work made with care and shipped throughout the United States.</p>
        </div>
      ...
      <main id="main-content">
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow">Bible rebinding & restoration · hand-bound journals · customizations · custom work</p>
            <h1>Crafted to hold <em>what matters.</em></h1>
            ...
            <a href="#services" className="hero-discover">Explore the craft <span aria-hidden="true">↓</span></a>
          </div>
          <div className="hero-visual" role="img" aria-label="An open leather-bound Bible with a blue ribbon on a wooden workbench"><div className="hero-stamp"><span>For all the chapters to come.</span></div></div>
        </section>

        <section className="section"><div className="container intro"><div className="intro-copy"><p className="eyebrow">A better kind of repair</p><h2>Keep the pages. Renew the feeling.</h2><p>That Bible on your shelf carries your story—the notes in the margins, the underlined verses, the worn spine from years of use. Logos Custom Bindings gives those pages a new life without erasing what they mean.</p></div><div className="intro-list"><article><span className="index">01</span><div><h3>Bible rebinding & restoration</h3><p>Real leather covers, careful restoration, and a stronger structure for your most trusted book.</p></div></article><article><span className="index">02</span><div><h3>Hand-bound journals</h3><p>Custom journals and notebooks made with premium materials, vibrant colors, and personal details.</p></div></article><article><span className="index">03</span><div><h3>Customizations</h3><p>Choose leather, color, imprinting, ribbons, tooled ribs, and finishing touches that make it yours.</p></div></article><article><span className="index">04</span><div><h3>Custom work</h3><p>Bring us your idea for a note pad holder, custom cover, or another useful object made one piece at a time.</p></div></article></div></div></section>

        <section id="services" className="section maroon-band"><div className="container"><div className="section-header"><div><p className="eyebrow">Exclusive services</p><h2>Custom bookbinding, made to be uniquely yours.</h2></div><div className="service-intro"><p>At Logos Custom Bindings, we specialize in custom-made, hand-crafted book covers and personalized bookbinding services for Bibles, journals, notebooks, note pads, and more. Our commitment to quality and attention to detail ensures every piece is truly one of a kind.</p><p>For a distinctive gift or a meaningful book of your own, our studio—led by Johnny—creates carefully considered work around your exact specifications. We also carry a selection of brand-new Bibles and journals through Etsy.</p><a href="https://www.etsy.com/" target="_blank" rel="noreferrer">Explore the Etsy collection ↗</a></div></div><div className="service-grid"><a className="service-card" href="/bible-rebinding/"><span className="card-number">01</span><div><h3>Bible Rebinding & Restoration</h3><p>Restore your faithful companion with real leather, reinforced structure, and details chosen around your story.</p></div><span className="service-link">Explore the work ↗</span></a><a className="service-card" href="/hand-bound-notebooks/"><span className="card-number">02</span><div><h3>Hand-Bound Journals</h3><p>Discover custom journals and notebooks made with premium materials, vibrant colors, and personal details.</p></div><span className="service-link">Explore the work ↗</span></a><a className="service-card" href="/customizations/"><span className="card-number">03</span><div><h3>Customizations</h3><p>Make a Bible, journal, or notebook one-of-a-kind with imprinting, ribbons, color, and thoughtful finishing.</p></div><span className="service-link">Explore the work ↗</span></a><a className="service-card" href="/custom-work/"><span className="card-number">04</span><div><h3>Custom Work</h3><p>Bring us your idea for a note pad holder, custom cover, or other useful object made one piece at a time.</p></div><span className="service-link">Explore the work ↗</span></a></div></div></section>

        <ReviewsSection />

        <section className="section"><div className="container"><div className="section-header"><div><p className="eyebrow">Selected work</p><h2>Made one piece at a time.</h2></div><a href="/portfolio/" className="button secondary">See the portfolio ↗</a></div><PortfolioGallery featured /></div></section>
...
function PortfolioPageReal() {
  return <Shell><main id="main-content"><section className="page-hero"><div className="container"><Breadcrumbs current="Portfolio" /><p className="eyebrow">Past work</p><h1>Objects made to become part of the story.</h1><p className="lead">Explore real examples of custom Bible rebinding, leather Bible covers, personalized imprinting, hand-bound journals, and carefully finished bookbinding work.</p></div></section><section className="section"><div className="container"><PortfolioGallery /><div className="quote-strip rule"><div><p className="eyebrow">Your project will be different</p><h2>Bring us the idea, the heirloom, or the worn favorite.</h2></div><a className="button" href="/request-a-quote/">Start a conversation</a></div></div></section></main></Shell>;
}
...
function ProcessPage() {
  ...
  return <Shell><main id="main-content"><section className="page-hero"><div className="container"><Breadcrumbs current="Process" /><p className="eyebrow">How it works</p><h1>A clear path from worn to wonderful.</h1><p className="lead">We make the process personal, practical, and easy to understand—even when the project itself is one of a kind.</p></div></section><section className="section"><div className="container"><div className="process-grid">{steps.map(([number, title, copy]) => <article className="process-step" key={number}><span className="step-num">{number}</span><h3>{title}</h3><p>{copy}</p></article>)}</div></div></section><section className="section" style={{ background: "#ede5da" }}><div className="container intro"><div className="intro-copy"><p className="eyebrow">Before you send it</p><h2>What helps us give you a thoughtful answer.</h2></div><div className="intro-list"><article><span className="index">01</span><div><h3>Tell us how you use it</h3><p>Daily carry, study, gifting, family history, or a special occasion all point toward different choices.</p></div></article><article><span className="index">02</span><div><h3>Share the condition</h3><p>Photos of the cover, spine, corners, and pages help us understand the starting point.</p></div></article><article><span className="index">03</span><div><h3>Name the feeling</h3><p>Traditional, understated, expressive, rugged, or refined—your direction helps shape the material palette.</p></div></article></div></div></section></main></Shell>;
}

function AboutPage() {
  return <Shell schema={<OrganizationSchema />}><main id="main-content"><section className="page-hero"><div className="container"><Breadcrumbs current="Our Story" /><p className="eyebrow">The hands behind the work</p><h1>Good work starts with paying attention.</h1><p className="lead">Led by Johnathan Huggins, Logos Custom Bindings creates personalized, hand-crafted covers and bindings for Bibles, journals, notebooks, and the books people are not ready to let go of.</p></div></section><section className="section story-section"><div className="container story-layout"><div className="story-quote"><p className="eyebrow">A word worth preserving</p><blockquote>“Thy word have I hid in mine heart, that I might not sin against thee.”</blockquote><cite>Psalm 119:11</cite><Image unoptimized={process.env.NODE_ENV === "development"} className="story-image" src="/portfolio/bible-rebinding-imprinting.jpg" alt="Scripture imprinted in gold on a custom leather Bible, with tooled spine and personalized ribbons" width={720} height={900} /></div><div className="prose story-copy"><p>If you were to look up the original Hebrew word for “hid,” you would find it could be translated as “treasured up.” And the Bible is truly a treasure of treasures. Nowhere else can we discover the character and the mind of God, His will for our lives, and, most importantly, salvation.</p><p>It is the greatest work of literature ever written. Its words are alive and have withstood the test of time, and they will remain sure and true when all else has crumbled away to dust.</p><p>That is why I have a passion for preserving such a precious book. Though its words are eternal, its carrying case is not. God has blessed what started out as a simple hobby and turned it into a service.</p><p>I take Bible rebinding very seriously. I take the utmost care in how I handle each and every one I do, and I use only the highest quality materials available. I never use fake, bonded, or so-called “genuine” leather that will crack and delaminate over time. I use real skins that lend a soft, pliable cover that will last.</p><p>Spine reinforcement and edge lining come standard with every rebind, adding extra strength and durability. I can also add finishing touches such as tooled ribs or imprinting options—whatever you need to personalize your Bible and make it stand out.</p><p>Thank you for visiting Logos Custom Bindings. Feel free to reach out with any questions or if you would like a quote. And don’t forget to connect and follow LCB on Facebook and Instagram. God bless!</p><p className="story-signoff">Johnathan Huggins</p></div></div></section><section className="section maroon-band"><div className="container quote-strip"><div><p className="eyebrow">Made with patience</p><h2>Bring something meaningful. We’ll help you give it a future.</h2></div><a className="button secondary" style={{ borderColor: "#f2d5a9", color: "#fff5e8" }} href="/request-a-quote/">Request a Quote ↗</a></div></section></main></Shell>;
}
...
export function generateRouteMetadata(route: string): Metadata {
  ...
  const titles: Record<string, [string, string]> = {
    ...
    about: ["About Logos Custom Bindings", "Meet Johnathan Huggins and learn why Logos Custom Bindings is devoted to preserving meaningful Bibles and books with lasting materials and careful craftsmanship."],
